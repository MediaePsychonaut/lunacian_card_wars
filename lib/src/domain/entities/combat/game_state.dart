...
// [INTENT]: Root snapshot of the combat game state tracking turn order and tile precedence
...
class GameState {
  ...
  final PlayerId? firstTilePlacer;
  ...
  GameState copyWith({
    ...
    return GameState(
      ...
      firstTilePlacer: firstTilePlacer ?? this.firstTilePlacer,
